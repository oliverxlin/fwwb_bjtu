        ...
        def dev_step(x_batch, y_batch):
            ...
            for batch in dev_batches:
                ...
                if len(x_batch_dev) < batch_size:
                    continue
                step,  temp_loss, temp_accuracy1, temp_accuracy2, temp_accuracy3 = sess.run(
                    [global_step,cnn.loss, cnn.predictions1, cnn.predictions2, cnn.predictions3],
                    feed_dict)
                # print(temp_accuracy1[0:10])
                # print("Test:", np.argmax( y_batch1_dev[0:10], axis = 1))
